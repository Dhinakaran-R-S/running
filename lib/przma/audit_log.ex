defmodule Przma.AuditLog do
  ...
  defp check_suspicious_activity(attrs) do
    ...
    if failed_login_count >= 5 do
      Logger.warning("Suspicious activity detected: Multiple failed logins for user #{attrs.user_id}")
    ...
    if data_access_count >= 50 do
      Logger.warning("Suspicious activity detected: Unusual data access volume for user #{attrs.user_id}")
